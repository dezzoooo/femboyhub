    ...
    Title = 'FemboyHub | @kysvell .gg/praying',
    Center = true,
    AutoShow = true,
    TabPadding = 9
    })
...
-- Define the notification function
    ...
    cout("Skibidi Changer")           
			...
			['Aqua'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						C0 = newCFrame(-0.105384827, 0.208259106, 0.00799560547, 1, -5.8738132e-27, 0, -5.8738132e-27, 1, 0, 0, 0, 1)
					},
					['[Double-Barrel SG]'] = {
						location = meshes.Aqua.db,
						equipped = false,
						shoot_sound = 'rbxassetid://137783932140587',
						C0 = newCFrame(0.204410553, 0.268578529, 0.0223999023, -1.00000572, 2.902789e-27, 0, -2.9027553e-27, 0.999988556, 0, 0, 0, -0.999994278)
					},
					['RPG'] = {
						location = meshes.Aqua.rpg,
						equipped = false,
						shoot_sound = 'rbxassetid://136641811532905',
						C0 = newCFrame(-0.0422363281, 0.243108392, -0.243370056, -4.371139e-8, 1.7969543e-18, -1, -5.647312e-13, 1, -1.7722692e-18, 1, -5.647312e-13, -4.371139e-8)
					}
				}
			},
			['Arcade'] = {
				...
				guns = {
					['Revolver'] = {
						...
						C0 = newCFrame(0.0578613281, -0.0479719043, -0.00115966797, -1.00000405, 1.1559613e-16, 1.6426729e-30, -1.1559613e-16, 1, 2.99752e-14, 1.6668305e-30, -2.99752e-14, -1.00000405)
					},
					['Double-Barrel SG'] = {
			...
			['Barbie'] = {
				guns = {
					...
					['[RPG]'] = {
						...
						equipped = false,
						C0 = newCFrame(-0.0417480469, 0.253171682, 1.63067627, 4.371139e-8, 3.4694465e-18, 1, -4.0086567e-13, 1, 3.486969e-18, -1, 4.0086567e-13, 4.371139e-8)
					},
					['[Flamethrower]'] = {
		...
		['CandyCane'] = {
			color = newColorSequence({newColorSequenceKeypoint(0, Color3.new(1, 1, 1)), ColorSequenceKeypoint.new(0.25, Color3.new(1, 0, 0)), ColorSequenceKeypoint.new(0.5, Color3.new(1, 1, 1)), ColorSequenceKeypoint.new(0.75, Color3.new(1, 0, 0)), ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))}),
				guns = {
					['[Revolver]'] = {
						location = meshes.CandyCane.Rev,
						equipped = false,
						shoot_sound = 'rbxassetid://134944277318607',
						C0 = newCFrame(0.3, -0.0479719043, -0.00115966797, -1.00000405, 1.1559613e-16, 1.6426729e-30, -1.1559613e-16, 1, 2.99752e-14, 1.6668305e-30, -2.99752e-14, -1.00000405)
					},
				}
			},
			['PrestigeCandyCane'] = {
				color = newColorSequence({newColorSequenceKeypoint(0, Color3.new(1, 1, 1)), ColorSequenceKeypoint.new(0.25, Color3.new(0.5, 0, 0.5)), ColorSequenceKeypoint.new(0.5, Color3.new(1, 1, 1)), ColorSequenceKeypoint.new(0.75, Color3.new(0.5, 0, 0.5)), ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))}),
					guns = {
						['[Revolver]'] = {
			...
			['Cat'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						C0 = newCFrame(-0.0353851318, 0.0917409062, -0.001953125, 1, 0, 0, 0, 1, -3.2505985e-30, 0, -3.2505985e-30, 1)
					},
					['[Double-Barrel SG]'] = {
						location = meshes.Cat.db,
						equipped = false,
						shoot_sound = 'rbxassetid://18544603790',
						C0 = newCFrame(-0.321357727, -0.021577239, -0.000366210938, -1, 0, 0, 0, 1, -3.2505977e-30, 0, 3.2505977e-30, -1)
					},
					['[Drum-Shotgun]'] = {
						location = meshes.Cat.drum,
						equipped = false,
						shoot_sound = 'rbxassetid://18544602257',
						C0 = newCFrame(-0.0637664795, 0.164270639, 0.00408935547, -1, 1.6292068e-7, 1.7956824e-22, 1.6292068e-7, 1, -2.4492725e-16, 1.9951958e-23, -2.449298e-16, -1)
					},
					['RPG'] = {
						location = meshes.Cat.rpg,
						equipped = false,
						shoot_sound = 'rbxassetid://18544610124',
						C0 = newCFrame(-0.0182495117, 0.288909316, -0.0680465698, -4.371139e-8, 4.5474735e-13, -1, 0.00000192143443, 1, -5.3873594e-13, 1, 0.00000192143443, -4.371139e-8)
					}
				}
			},
			['Hoodmas'] = {
			...
			['Web-Hero'] = {
				...
				guns = {
					['Revolver'] = {
						...
						C0 = newCFrame(-0.0891418457, -0.0215809345, -0.0041809082, -1.9952033e-23, -1.6292068e-7, 1, 2.4492937e-16, 1, 1.6292068e-7, -1, 2.4492937e-16, 1.995203e-23)
					}
				}
			},
			...
			['Mystical'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						C0 = newCFrame(-0.015838623, -0.0802496076, 0.00772094727, 1, 0, 4.371139e-8, 0, 1, 0, -4.371139e-8, 0, 1)
					},
				}
			},
			['CyanPack'] = {
				...
				guns = {
					...
					['[Double-Barrel SG]'] = {
						...
						C0 = newCFrame(-0.00828552246, 0.417651355, -0.00537109375, 0.0000041835838, -1.6292068e-7, 1, 3.4104116e-13, 1, 1.6292068e-7, -1, 3.4104105e-13, -0.0000041835838)
					},
					['[Revolver]'] = {
			...
			['Cartoon'] = {
				...
				guns = {
					['[Flamethrower]'] = {
						...
						equipped = false,
						C0 = newCFrame(-0.272186279, 0.197086751, 0.0440063477, -1, 4.801877e-7, 8.707895e-8, 4.801876e-7, 1, -3.5477998e-7, -8.707912e-8, -3.5477996e-7, -1)
					},
					['[Revolver]'] = {
						location = meshes.Cartoon.CartoonRev,
						equipped = false,
						shoot_sound = 'rbxassetid://14221101923',
						C0 = newCFrame(-0.015411377, 0.0135096312, 0.00338745117, 1.00000095, 3.4132655e-13, 2.842174e-14, 3.4132655e-13, 1.00000191, -9.894907e-10, 2.842174e-14, -9.894907e-10, 1.00000191)
					},
					['[Double-Barrel SG]'] = {
						location = meshes.Cartoon.DBCartoon,
						equipped = false,
						shoot_sound = 'rbxassetid://14220912852',
						C0 = newCFrame(0.00927734375, -0.00691050291, 0.000732421875, -1, -2.7939677e-8, -9.313228e-10, -2.7939677e-8, 1, 1.4260787e-8, 9.313226e-10, 1.4260787e-8, -1)
					},
					['[RPG]'] = {
						location = meshes.Cartoon.RPGCartoon,
						equipped = false,
						C0 = newCFrame(-0.0201721191, 0.289476752, -0.0727844238, 4.371139e-8, 6.5827684e-37, 1, -5.72632e-14, 1, 2.503054e-21, -1, 5.72632e-14, 4.371139e-8)
					},
				}
			},
			['Dragon'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						C0 = newCFrame(0.0384216309, 0.0450432301, -0.000671386719, 1.870454e-31, 4.211888e-16, -0.99999994, 1.7763568e-15, 1, -4.2118883e-16, 1, 1.7763568e-15, -1.8704541e-31)
					},
					['[Double-Barrel SG]'] = {
						location = meshes.Dragon.DBDragon,
						equipped = false,
						C0 = newCFrame(-0.123794556, 0.0481165648, 0.00048828125, 7.1469344e-7, 3.132837e-10, 1, -4.5665822e-9, 1, -3.1328168e-10, -1, -4.5665853e-9, 7.1469344e-7)
					}
				}
			},
			['Tact'] = {
				...
				guns = {
					...
					['[Silencer]'] = {
						...
						C0 = newCFrame(0.0766601562, -0.0350288749, -0.648864746, 1, 0, -4.371139e-8, 0, 1, 0, 4.371139e-8, 0, 1)
					}
				}
			},
			['Shadow'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						equipped = false,
						C0 = newCFrame(0.000015258789, 0, 0, 1, 0, 8.742278e-8, 0, 1, 0, -8.742278e-8, 0, 1)
					},
					['[Double-Barrel SG]'] = {
					...
					['[AK47]'] = {
						...
						equipped = false,
						C0 = newCFrame(-0.750015259, 4.7683716e-7, -0.000030517578, 1, 0, 0, 0, 1, 0, 0, 0, 1)
					},
					['[SilencerAR]'] = {
						location = meshes.Shadow.ARGhost,
						equipped = false,
						C0 = newCFrame(0.116256714, 0.0750004649, 0.000061035156, 1, 0, 0, 0, 1, 0, 0, 0, 1)
					},
					['[AUG]'] = {
						location = meshes.Shadow.AUGGhost,
						equipped = false,
						C0 = newCFrame(-0.0000076293945, 0.0499991775, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1)
					},
					['[DrumGun]'] = {
						location = meshes.Shadow.DrumgunGhost,
						equipped = false,
						C0 = newCFrame(0.000011444092, 0, 0, 1, 0, 8.742278e-8, 0, 1, 0, -8.742278e-8, 0, 1)
					},
					['[Flamethrower]'] = {
					...
					['[Glock]'] = {
						...
						equipped = false,
						C0 = newCFrame(0, 0, -0.200004578, 1, 0, 4.371139e-8, 0, 1, 0, -4.371139e-8, 0, 1)
					},
					['[LMG]'] = {
						location = meshes.Shadow.LMGGhost,
						equipped = false,
						C0 = newCFrame(0.374502182, -0.25, -0.25, -1, 0, -1.3113416e-7, 0, 1, 0, 1.3113416e-7, 0, -1)
					},
					['[P90]'] = {
						location = meshes.Shadow.P90Ghost,
						equipped = false,
						C0 = newCFrame(0.00006866455, 0.000218153, 0.000030517578, 1, 0, 0, 0, 1, 0, 0, 0, 1)
					},
					['[RPG]'] = {
						location = meshes.Shadow.RPGGhost,
						equipped = false,
						C0 = newCFrame(0.000122070312, 0.0625389814, 0.00672149658, 1, 0, -8.742278e-8, 5.006108e-21, 1, 5.72632e-14, 8.742278e-8, 5.72632e-14, 1)
					},
					['[Rifle]'] = {
						location = meshes.Shadow.RifleGhost,
						equipped = false,
						C0 = newCFrame(0.000244140625, -0.100267321, -0.000091552734, 1, 0, 0, 0, 1, 0, 0, 0, 1)
					},
					['[SMG]'] = {
						location = meshes.Shadow.SMGGhost,
						equipped = false,
						C0 = newCFrame(-0.000011444092, 1.7881393e-7, -0.0263671875, 1, 0, 0, 0, 1, 0, 0, 0, 1)
					},
					['[Shotgun]'] = {
						location = meshes.Shadow.ShotgunGhost,
						equipped = false,
						C0 = newCFrame(0.000030517578, 0.199999928, 0.0000038146973, -1, 0, -4.371139e-8, 0, 1, 0, 4.371139e-8, 0, -1)
					},
					['[TacticalShotgun]'] = {
						location = meshes.Shadow.TacticalShotgunGhost,
						equipped = false,
						C0 = newCFrame(-0.148262024, 0, 0, 1, 0, 8.742278e-8, 0, 1, 0, -8.742278e-8, 0, 1)
					}
				}
			},
			['Golden Age'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						equipped = false,
						C0 = newCFrame(0.0295257568, 0.0725820661, -0.000946044922, 1, -4.8985874e-16, -7.9808124e-23, 4.8985874e-16, 1, 3.2584137e-7, -7.9808124e-23, -3.2584137e-7, 1),
					...
					['[Double-Barrel SG]'] = {
						...
						C0 = newCFrame(-0.00664520264, 0.0538104773, 0.0124816895, -1, 4.8985874e-16, 7.9808124e-23, 4.8985874e-16, 1, 3.2584137e-7, 7.9808124e-23, 3.2584137e-7, -1)
					}
				}
			},
			['Red Skull'] = {
				color = newColorSequence({newColorSequenceKeypoint(0, Color3.new(1, 0, 0)), ColorSequenceKeypoint.new(0.25, Color3.new(1, 0, 0)), ColorSequenceKeypoint.new(0.5, Color3.new(0, 0, 0)), ColorSequenceKeypoint.new(0.75, Color3.new(1, 0, 0)), ColorSequenceKeypoint.new(1, Color3.new(1, 0, 0))}),
				guns = {
					['[Revolver]'] = {
					...
					['[Shotgun]'] = {
						...
						equipped = false,
						C0 = newCFrame(-0.00326538086, 0.0239292979, -0.039352417, -4.371139e-8, 0, -1, 0, 1, 0, 1, 0, -4.371139e-8)
					},
					['[Double-Barrel SG]'] = {
					...
					['[RPG]'] = {
						...
						C0 = newCFrame(-0.00149536133, 0.254377961, 0.804840088, -1, 0, 4.371139e-8, -2.503054e-21, 1, -5.72632e-14, -4.371139e-8, 5.72632e-14, -1)
					}
				}
			},
			--[[['Galaxy'] = {
			...
			['Kitty'] = {
				...
				guns = {
					...
					['[Flamethrower]'] = {
						...
						equipped = false,
						C0 = newCFrame(-0.265670776, 0.115545571, 0.00997924805, -1, 9.74078e-21, 5.471241e-13, 9.740929e-21, 1, 3.126388e-13, -5.471263e-13, 3.126388e-13, -1)
					},
					['[RPG]'] = {
						location = meshes.Kitty.KittyRPG,
						equipped = false,
						C0 = newCFrame(0.0268554688, 0.0252066851, 0.117408752, -1, 2.51111e-40, 4.371139e-8, -3.7545812e-20, 1, -8.58948e-13, -4.371139e-8, 8.58948e-13, -1)
					},
					['[Shotgun]'] = {
						location = meshes.Kitty.KittyShotgun,
						equipped = false,
						shoot_sound = 'rbxassetid://13483035672',
						C0 = newCFrame(0.0233459473, 0.223892093, -0.0213623047, 4.3711896e-8, -6.536993e-13, 1, 3.4728474e-20, 1, 7.3896445e-13, -0.999997139, 8.695067e-21, 4.3711935e-8)
					}
				}
			},
			['Toy'] = {
				...
				guns = {
					...
					['[LMG]'] = {
						...
						C0 = newCFrame(-0.285247803, -0.0942560434, -0.270412445, 1, 0, 4.371139e-8, 0, 1, 0, -4.371139e-8, 0, 1)
					},
					['[Double-Barrel SG]'] = {
					...
					['[RPG]'] = {
						...
						C0 = newCFrame(0.00121307373, 0.261434197, -0.318969727, 1, 2.576844e-12, -4.371139e-8, 2.5768441e-12, 1, 6.2989522e-12, 4.371139e-8, 6.2989522e-12, 1)
					}
				}
			},
			['Galactic'] = {
				...
				guns = {
					...
					['[TacticalShotgun]'] = {
						...
						equipped = false,
						C0 = newCFrame(-0.0411682129, -0.0281000137, 0.00103759766, 0, 5.684342e-14, 1, -1.9145682e-13, 1, 5.684342e-14, -1, 1.9145682e-13, 0)
					}
				}
			},
			['Water'] = {
			...
			['GPO'] = {
				...
				guns = {
					['[RPG]'] = {
						...
						equipped = false,
						C0 = newCFrame(-0.0184631348, 0.0707798004, 0.219360352, 4.371139e-8, 1.07062025e-23, 1, -5.750813e-14, 1, 1.14251725e-36, -1, 5.7018274e-14, 4.371139e-8)
					},
					['[TacticalShotgun]'] = {
						location = meshes.GPO.MaguTact,
						equipped = false,
						shoot_sound = 'rbxassetid://13998711419',
						C0 = newCFrame(-0.282501221, 0.0472121239, -0.0065612793, -0.000006606245, 1.5649757e-8, -1, -5.684342e-14, 1, -1.564868e-8, 1, 5.684342e-14, -0.000006606245)
					},
					['[Rifle]'] = {
						location = meshes.GPO.Rifle,
						equipped = false,
						C0 = newCFrame(-0.208007812, 0.185256913, 0.000610351562, -3.3708154e-14, 1.628034e-7, -1.00000012, -8.742277e-8, 0.999999881, 1.630362e-7, 1, 8.742278e-8, -1.9455252e-14)
					}
				}
			},
			['GPOII'] = {
				color = newColorSequence(Color3.new(0, 0.502, 1), Color3.new(1, 1, 1)),
				guns = {
					['[Double-Barrel SG]'] = {
			...
			['BIT8'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						C0 = newCFrame(0.0261230469, -0.042888701, 0.00260925293, -1, 1.355249e-20, -3.5527107e-15, 1.355249e-20, 1, -1.819033e-27, 3.5527107e-15, -1.819033e-27, -1)
					},
					['[Flamethrower]'] = {
					...
					['[RPG]'] = {
						...
						equipped = false,
						C0 = newCFrame(0.0102081299, 0.0659624338, 0.362945557, 4.371139e-8, 0, 1, -5.72632e-14, 1, 2.503054e-21, -1, 5.72632e-14, 4.371139e-8)
					}
				}
			},
			['Electric'] = {
				...
				guns = {
					...
					['[Shotgun]'] = {
						...
						equipped = false,
						C0 = newCFrame(0.000061035156, 0.180232108, -0.624732971, 1, 0, -4.371139e-8, 0, 1, 0, 4.371139e-8, 0, 1)
					},
					['[Rifle]'] = {
						location = meshes.Electric.ElectricRifle,
						equipped = false,
						C0 = newCFrame(0.181793213, -0.0415201783, 0.00421142578, 1.8189894e-12, 6.617445e-24, 1, 7.275958e-12, 1, 6.617445e-24, -1, -7.275958e-12, -1.8189894e-12)
					},
					['[P90]'] = {
					...
					['[LMG]'] = {
						...
						equipped = false,
						C0 = newCFrame(0.142379761, 0.104723871, -0.303771973, -1, 0, -4.371139e-8, 0, 1, 0, 4.371139e-8, 0, -1)
					},
					['[Flamethrower]'] = {
			...
			['Heaven'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						C0 = newCFrame(-0.0829315186, -0.0831851959, -0.00296020508, -0.999999881, 2.9408928e-17, 8.2717977e-25, -2.9408928e-17, 0.999999881, 6.852156e-16, 8.271799e-25, -6.8521567e-16, -1)
					},
					['[Double-Barrel SG]'] = {
						equipped = false,
						location = meshes.Heaven.DB,
						shoot_sound = 'rbxassetid://14489852879',
						C0 = newCFrame(-0.0303955078, 0.022110641, 0.00296020508, -0.999997139, -7.058122e-16, 7.855686e-30, 7.058122e-16, 0.999997139, -2.0650118e-14, 6.445185e-30, 2.0650104e-14, -0.999999046)
					}
				}
			},
			['Void'] = {
			...
			['DH-Verified'] = {
				...
				guns = {
					['[Revolver]'] = {
						...
						C0 = newCFrame(0.049407959, -0.0454721451, 0.00158691406, -1, 0, 0, 0, 1, 2.220446e-15, 0, -2.220446e-15, -1)
					}
				}
			},
			['Candy'] = {
				...
				guns = {
					...
					['LMG'] = {
						...
						C0 = newCFrame (0.125213623, -0.30771935, -0.0625305176, -4.371139e-8, 0, 1, 0, 1, 0, -1, 0, -4.371139e-8)
					}
				}
			}
		};
...
LeftGroupBox = Tabs.Misc:AddLeftGroupbox('Auto Stomp')
    ...
    local player = game.Players.LocalPlayer
    local stompInterval = 0.1 -- seconds between each stomp (default)
